#ifndef dummy_portable_laplace_operator_h
#define dummy_portable_laplace_operator_h
...
namespace Portable
{
  ...
  class DummyLaplaceOperator : public LaplaceOperatorBase<dim, number>
  {
  public:
    DummyLaplaceOperator(const DoFHandler<dim>           &dof_handler,
  ...
  template <int dim, int fe_degree, typename number>
  DummyLaplaceOperator<dim, fe_degree, number>::DummyLaplaceOperator(
  ...
  template <int dim, int fe_degree, typename number>
  void
  DummyLaplaceOperator<dim, fe_degree, number>::
    setup_dirichlet_boundary_dofs_masks()
  {
  ...
  template <int dim, int fe_degree, typename number>
  void
  DummyLaplaceOperator<dim, fe_degree, number>::vmult(
    LinearAlgebra::distributed::Vector<number, MemorySpace::Default>       &dst,
    ...
    const bool computation_on) const
  {
    ...
    this->cell_loop(cell_operator, src, dst, ghost_exchange_on, computation_on);
  ...
  template <int dim, int fe_degree, typename number>
  void
  DummyLaplaceOperator<dim, fe_degree, number>::cell_loop(
    const LocalLaplaceOperator<dim, fe_degree, number> &cell_operator,
    const LinearAlgebra::distributed::Vector<number, MemorySpace::Default> &src,
    LinearAlgebra::distributed::Vector<number, MemorySpace::Default>       &dst,
    const bool ghost_exchange_on,
  ...
  template <int dim, int fe_degree, typename number>
  void
  DummyLaplaceOperator<dim, fe_degree, number>::Tvmult(
    LinearAlgebra::distributed::Vector<number, MemorySpace::Default>       &dst,
    const LinearAlgebra::distributed::Vector<number, MemorySpace::Default> &src)
    const
  {
  ...
  template <int dim, int fe_degree, typename number>
  void
  DummyLaplaceOperator<dim, fe_degree, number>::initialize_dof_vector(
  ...
  template <int dim, int fe_degree, typename number>
  const MatrixFree<dim, number> &
  DummyLaplaceOperator<dim, fe_degree, number>::get_matrix_free() const
  {
    return matrix_free;
  }
  ...
  template <int dim, int fe_degree, typename number>
  void
  DummyLaplaceOperator<dim, fe_degree, number>::compute_diagonal()
  {
  ...
  std::shared_ptr<DiagonalMatrix<
    LinearAlgebra::distributed::Vector<number, MemorySpace::Default>>>
  DummyLaplaceOperator<dim, fe_degree, number>::get_matrix_diagonal_inverse()
    const
  {
  ...
  template <int dim, int fe_degree, typename number>
  types::global_dof_index
  DummyLaplaceOperator<dim, fe_degree, number>::m() const
  {
  ...
  template <int dim, int fe_degree, typename number>
  types::global_dof_index
  DummyLaplaceOperator<dim, fe_degree, number>::n() const
  {
    return matrix_free.get_vector_partitioner()->size();
  }
  ...
  template <int dim, int fe_degree, typename number>
  number
  DummyLaplaceOperator<dim, fe_degree, number>::el(
  ...
  template <int dim, int fe_degree, typename number>
  const std::shared_ptr<const Utilities::MPI::Partitioner> &
  DummyLaplaceOperator<dim, fe_degree, number>::get_vector_partitioner() const
  {
