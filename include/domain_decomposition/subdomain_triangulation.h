  ...
  const SubdomainTriangulation<dim> &other_subdomain_triangulation)
{
  ...
  topology_info.interface_id =
    other_subdomain_triangulation.topology_info.interface_id;
  topology_info.subdomain_id =
    other_subdomain_triangulation.topology_info.subdomain_id;
}
...
// template <typename TriaType>
// void
// SubdomainTriangulation<dim>::create_coarse_subdomain_triangulation(
//   TriaType &distributed_triangulation)
// {
//   this->clear();
//   this->topology_info.subdomain_id = Utilities::MPI::this_mpi_process(
...
//   this->topology_info.interface_id = 100 +
//   this->topology_info.subdomain_id;
...
//   for (const auto &cell :
//   distributed_triangulation.active_cell_iterators())
//     {
//       if (cell->is_locally_owned())
//         {
//           CellData<dim> cell_data;
